...
最后我们得到s道极点的贡献
\begin{align}
   \mathcal{M}=\mbox{i}\frac{g_A^2}{4F_{\pi}^2}\bar{u}(p^{\prime})\Bigl[2m_N+\frac{1}{2}(\slashed{q}+\slashed{q}^{\prime})\Bigl(-1-\frac{2m_N}{v-v_B}\Bigr)\Bigr]\tau_b \tau_a u(p).
\end{align}
...
类似与$\pi\pi$散射的同位旋分解，对于$\pi N$散射，我们有
\begin{align}
   \begin{aligned}
   T^{\frac{1}{2}}=&T^++2T^-,\\
   T^{\frac{3}{2}}=&T^+-T^-.
